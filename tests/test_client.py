...
class ClientTest(TestCase):
    ...
    def test_client_creates_a_content_type_cache(self):
        with vcr.use_cassette("fixtures/client/content_type_cache.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1")
            client.initialize()
    ...
    def test_client_get_space(self):
        with vcr.use_cassette("fixtures/client/space.yaml"):
    ...
    def test_client_get_content_type(self):
        with vcr.use_cassette("fixtures/client/content_type.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_get_content_types(self):
        with vcr.use_cassette("fixtures/client/content_types.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_entry(self):
        with vcr.use_cassette("fixtures/client/entry.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_entry_not_found(self):
        with vcr.use_cassette("fixtures/client/entry_not_found.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
            self.assertRaises(EntryNotFoundError, client.entry, "foobar")

    def test_client_entries(self):
        with vcr.use_cassette("fixtures/client/entries.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_entries_select(self):
        with vcr.use_cassette("fixtures/client/entries_select.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
            entries = client.entries(
    ...
    def test_client_entries_links_to_entry(self):
        with vcr.use_cassette("fixtures/client/entries_links_to_entry.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_entry_incoming_references(self):
        with vcr.use_cassette("fixtures/client/entry_incoming_references.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
            entry = client.entry("nyancat")
    ...
    def test_entry_incoming_references_with_query(self):
        with vcr.use_cassette(
            ...
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
            entry = client.entry("nyancat")
            entries = entry.incoming_references(
                client, {"content_type": "cat", "select": ["fields.name"]}
            )
            self.assertEqual(len(entries), 1)
            self.assertEqual(str(entries[0]), "<Entry[cat] id='happycat'>")
    ...
    def test_client_entries_links_to_asset(self):
        with vcr.use_cassette("fixtures/client/entries_links_to_asset.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_asset_incoming_references(self):
        with vcr.use_cassette("fixtures/client/asset_incoming_references.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_asset(self):
        with vcr.use_cassette("fixtures/client/asset.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
            asset = client.asset("nyancat")
    ...
    def test_client_locales_on_environment(self):
        with vcr.use_cassette("fixtures/client/locales_on_environment.yaml"):
            client = Client(
                "facgnwwgj5fe",
                "<ACCESS_TOKEN>",
                environment="testing",
    ...
    def test_client_assets(self):
        with vcr.use_cassette("fixtures/client/assets.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_sync(self):
        with vcr.use_cassette("fixtures/client/sync.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
    ...
    def test_client_sync_with_environments(self):
        with vcr.use_cassette("fixtures/client/sync_environments.yaml"):
            client = Client(
                "a22o2qgm356c",
    ...
    def test_client_creates_wrapped_arrays(self):
        with vcr.use_cassette("fixtures/client/array_endpoints.yaml"):
            client = Client("cfexampleapi", "b4c0n73n7fu1", content_type_cache=False)
            self.assertEqual(
                str(client.content_types()),
            ...
            self.assertEqual(
                str(client.assets()), "<Array size='4' total='4' limit='100' skip='0'>"
            )
    ...
    def test_entries_dont_fail_with_unicode_characters(self):
        with vcr.use_cassette("fixtures/integration/issue-4.yaml"):
            client = Client(
                "wltm0euukdog",
    ...
    def test_entries_dont_fail_with_arrays_as_json_root(self):
        with vcr.use_cassette("fixtures/integration/json-arrays.yaml"):
            client = Client(
                "4int1zgmkwcf",
    ...
    def test_entries_with_none_values_on_all_fields(self):
        with vcr.use_cassette("fixtures/integration/issue-11.yaml"):
            client = Client(
                "rtx5c7z0zbas",
    ...
    def test_circular_references_default_depth(self):
        with vcr.use_cassette("fixtures/integration/circular-references.yaml"):
            client = Client(
                "rk19fq93y3vw",
    ...
    def test_unresolvable_entries_dont_get_included(self):
        with vcr.use_cassette("fixtures/integration/errors-filtered.yaml"):
            client = Client(
                "011npgaszg5o",
    ...
    def test_rich_text_field(self):
        with vcr.use_cassette("fixtures/fields/rich_text.yaml"):
            client = Client(
                "jd7yc4wnatx3",
    ...
    def test_rich_text_field_with_embeds_in_lists(self):
        with vcr.use_cassette("fixtures/fields/rich_text_lists_with_embeds.yaml"):
            client = Client(
                "jd7yc4wnatx3",
                "6256b8ef7d66805ca41f2728271daf27e8fa6055873b802a813941a0fe696248",
                gzip_encoded=False,
    ...
    def test_rich_text_fields_should_not_get_hydrated_twice(self):
        with vcr.use_cassette("fixtures/integration/issue-41.yaml"):
            client = Client(
                "fds721b88p6b",
